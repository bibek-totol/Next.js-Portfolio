    ...
    <a
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-blue-950 border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-cyan-400 ">
            <span
            ...
            <span
              className="absolute -bottom-0 left-[1.125rem] h-[0.15rem] w-[calc(100%-2.25rem)] bg-gradient-to-r from-emerald-400/0 via-cyan-400 to-emerald-400/0 transition-opacity duration-500 group-hover/btn"></span>
          </a>
        </div>
